      ...
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          ...
          {mode === "photo" && (
            <>
              <button
                className="flex items-center justify-center w-20 h-20 rounded-full border-4 border-white bg-white/30 backdrop-blur-sm shadow-lg transition-all duration-150 hover:scale-110 active:scale-95 md:w-24 md:h-24"
